 ...
 <div class="form-container animate__animated animate__backInRight w-100 overflow-hidden d-flex justify-content-center align-items-center position-absolute">
     ...
     <div class="form-section" id="formSection">
         <div id="loginForm" class="form active">
             <h2 class="h2-login text-center fw-bold">Login</h2>
             ...
             <div class="text-center d-flex justify-content-between">
                 <button class=" btn btn-link mt-3 " id="forgotPasswordBtn">Forgot Password</button>
                 <button class="btn  btn-link" id="createAccountBtn">Create New Account</button>
             </div>
         </div>

         <div id="forgotPasswordForm" id="forgotPasswordBtn" class="form">
             <h2 class="h2-login text-center fw-bold">Forgot Password</h2>
             <form>
                 <div class="mb-3">
                     <div class="input-group">
                         <label for="resetEmail" class="form-label"></label>
                         <input type="email" class="form-control" placeholder="Email" id="resetEmail">
                         <span class="input-group-text"><i class="fas fa-envelope"></i></span>
                     </div>
                 </div>
                 <button type="submit" class="btn btn-primary w-100">Reset Password</button>
             </form>
             <button class="btn btn-link mt-3" id="backToLogin1">Back to Login<i class="fa-solid fa-arrow-right"></i></button>
         </div>

         <div id="createAccountForm" id="createAccountBtn" class="form">
             <h2 class="h2-login text-center fw-bold ">Create New Account</h2>
             <form>
                 <div class="mb-3">
                     <div class="input-group">
             ...
             <button class="btn btn-link mt-3" id="backToLogin2">Back to Login <i class="fa-solid fa-arrow-right"></i></button>
         </div>
     </div>
 </div>
    <!-- Fille Footer  -->
